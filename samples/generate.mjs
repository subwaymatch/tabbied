...
// The gallery landing page (/samples/) is a React route now — see
// app/samples/page.tsx — so its thumbnails render with the live TabbiedArtwork
// component. This script only emits the ten static site pages above plus the
// vendored runtime they load.
